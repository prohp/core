...
{
    /**
     * Имя класса модели или сама модель
     *
     * @var string|ActiveRecord
     */
    public $target;
    /**
     * Имя модуля к которому относится модель
     *
     * @var string
     */
    public $module;
    ...
    public $privileges;
    /**
     * Список лейблов для привилегий (для формирования названия пермишена)
    ...
    /**
     * Список параметров для проверки пермишена
     * @see can()
     *
     * @var array
     */
    ...
    {
        // проверить все привилегии в массиве
