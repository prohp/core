...
class Chart extends Widget
{
    ...
    /**
     * @var array
     * Добавить суффикс _CALLBACK к имени свойства для передачи анонимной функции.
     */
    public $chartConfig;
    /**
     * @var float
    ...
    public function init()
    {
        ...
        $this->clientViewOptions = [
            // todo: падает при инициализации графика Dashboard_CriticalIndexChart, если не энкодить chartConfig
...
//        $this->jsonEncodeOptions = JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_QUOT | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS;
    ...
    public function run()
    {
        ...
        if (!empty($this->chartData)) {
            ...
            $content .= 'No data';//NoDataPlaceholderWidget::widget();
        }
