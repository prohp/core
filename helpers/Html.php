...
class Html extends \yii\bootstrap\Html
{
	...
	/**
	 * @see \yii\db\ColumnSchema::$type список возможных типов колонок
	 * можно использовать ключи input или widget
	 * если присутсвуют оба, приоритет будет отдан widget
	 *
	 * @var array
	 */
	...
	public static function getInputType($model, $attribute, array $options = [])
	{
		...
		// Инпут для колонок типа статус, приоритет, тип и т.д.
		// Если есть метод {attributeName}Labels или статический метод get{AttributeName}Labels
		...
		// Инпут для связей. Если имя атрибута *_id, *Id - hasOne, *Ids - hasMany
...
//		if (!$model->isChangeable($attribute)) {
//			$type = ArrayHelper::merge($type, [
//				'disabled' => true,
//			]);
//		}
...
//        $name = isset($options['name']) ? $options['name'] : static::getInputName($model, $attribute);
    ...
    /**
     * @todo check на afterUpdateBlockId
...
JS;
	 ...
	 * Bootstrap строка
	 *
	 * Пример контента в формате массива
	 * ['col1', 'col2']
	 * <div class="row">
